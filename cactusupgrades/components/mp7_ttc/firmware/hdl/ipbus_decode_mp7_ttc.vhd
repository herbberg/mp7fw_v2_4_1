...
-- START automatically  generated VHDL the Sat Oct 28 08:05:27 2017 
    if    std_match(addr, "---------------------------00---") then
      ...
      sel := ipbus_sel_t(to_unsigned(N_SLV_CMD_CTRS, IPBUS_SEL_WIDTH)); -- cmd_ctrs / base 0x00000010 / mask 0x0000001e
    elsif std_match(addr, "---------------------------1001-") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_TMT, IPBUS_SEL_WIDTH)); -- tmt / base 0x00000012 / mask 0x0000001e
-- END automatically generated VHDL
